...
module transmitter_transmitter_Pipeline_VITIS_LOOP_193_93 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        dataUpsampledI_V_q0,
        dataPSI_acc_V_46_out,
        dataPSI_acc_V_46_out_ap_vld
);
...
output   ap_idle;
output   ap_ready;
input  [12:0] or_ln182_2;
output  [12:0] dataUpsampledI_V_address0;
output   dataUpsampledI_V_ce0;
input  [15:0] dataUpsampledI_V_q0;
output  [15:0] dataPSI_acc_V_46_out;
output   dataPSI_acc_V_46_out_ap_vld;

reg ap_idle;
reg dataUpsampledI_V_ce0;
reg dataPSI_acc_V_46_out_ap_vld;
...
transmitter_mac_muladd_16s_16s_31ns_31_4_1 #(
    ...
    .din2_WIDTH( 31 ),
    .dout_WIDTH( 31 ))
mac_muladd_16s_16s_31ns_31_4_1_U19(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln193_fu_283_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            j_4_fu_240 <= add_ln193_fu_289_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_j = j_4_fu_240;
    end
end

always @ (*) begin
    if (((icmp_ln193_fu_283_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataPSI_acc_V_46_out_ap_vld = 1'b1;
    end else begin
        dataPSI_acc_V_46_out_ap_vld = 1'b0;
    end
end
...
assign dataPSI_acc_V_46_out = lhs_fu_236;
...
assign sub_ln198_fu_299_p2 = (or_ln182_2 - zext_ln193_fu_295_p1);

assign zext_ln1271_fu_305_p1 = sub_ln198_fu_299_p2;

assign zext_ln193_fu_295_p1 = ap_sig_allocacmp_j;

endmodule //transmitter_transmitter_Pipeline_VITIS_LOOP_193_93
