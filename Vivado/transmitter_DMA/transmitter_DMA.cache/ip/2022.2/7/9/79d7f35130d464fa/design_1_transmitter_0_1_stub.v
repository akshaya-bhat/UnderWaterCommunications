...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_transmitter_0_1_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_control_AWADDR, 
  ...
  output_q_TID)
/* synthesis syn_black_box black_box_pad_pin="s_axi_control_AWADDR[3:0],s_axi_control_AWVALID,s_axi_control_AWREADY,s_axi_control_WDATA[31:0],s_axi_control_WSTRB[3:0],s_axi_control_WVALID,s_axi_control_WREADY,s_axi_control_BRESP[1:0],s_axi_control_BVALID,s_axi_control_BREADY,s_axi_control_ARADDR[3:0],s_axi_control_ARVALID,s_axi_control_ARREADY,s_axi_control_RDATA[31:0],s_axi_control_RRESP[1:0],s_axi_control_RVALID,s_axi_control_RREADY,ap_clk,ap_rst_n,interrupt,input_i_TVALID,input_i_TREADY,input_i_TDATA[31:0],input_i_TDEST[5:0],input_i_TKEEP[3:0],input_i_TSTRB[3:0],input_i_TUSER[1:0],input_i_TLAST[0:0],input_i_TID[4:0],input_q_TVALID,input_q_TREADY,input_q_TDATA[31:0],input_q_TDEST[5:0],input_q_TKEEP[3:0],input_q_TSTRB[3:0],input_q_TUSER[1:0],input_q_TLAST[0:0],input_q_TID[4:0],output_i_TVALID,output_i_TREADY,output_i_TDATA[31:0],output_i_TDEST[5:0],output_i_TKEEP[3:0],output_i_TSTRB[3:0],output_i_TUSER[1:0],output_i_TLAST[0:0],output_i_TID[4:0],output_q_TVALID,output_q_TREADY,output_q_TDATA[31:0],output_q_TDEST[5:0],output_q_TKEEP[3:0],output_q_TSTRB[3:0],output_q_TUSER[1:0],output_q_TLAST[0:0],output_q_TID[4:0]" */;
