...
set C_modelArgList {
	{ filt_3_I int 18 regular {array 12 { 1 1 } 1 1 }  }
	{ filt_4_I int 18 regular {array 6 { 0 3 } 0 1 }  }
	{ filt_3_Q int 18 regular {array 12 { 1 1 } 1 1 }  }
	{ filt_4_Q int 18 regular {array 6 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ filt_3_I_address0 sc_out sc_lv 4 signal 0 } 
	{ filt_3_I_ce0 sc_out sc_logic 1 signal 0 } 
	{ filt_3_I_q0 sc_in sc_lv 18 signal 0 } 
	{ filt_3_I_address1 sc_out sc_lv 4 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "filt_3_I_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "filt_3_I", "role": "address1" }} , 
 	...
 	{ "name": "filt_3_Q_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "filt_3_Q", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	filt_3_I { ap_memory {  { filt_3_I_address0 mem_address 1 4 }  { filt_3_I_ce0 mem_ce 1 1 }  { filt_3_I_q0 in_data 0 18 }  { filt_3_I_address1 MemPortADDR2 1 4 }  { filt_3_I_ce1 MemPortCE2 1 1 }  { filt_3_I_q1 in_data 0 18 } } }
	filt_4_I { ap_memory {  { filt_4_I_address0 mem_address 1 3 }  { filt_4_I_ce0 mem_ce 1 1 }  { filt_4_I_we0 mem_we 1 1 }  { filt_4_I_d0 mem_din 1 18 } } }
	filt_3_Q { ap_memory {  { filt_3_Q_address0 mem_address 1 4 }  { filt_3_Q_ce0 mem_ce 1 1 }  { filt_3_Q_q0 in_data 0 18 }  { filt_3_Q_address1 MemPortADDR2 1 4 }  { filt_3_Q_ce1 MemPortCE2 1 1 }  { filt_3_Q_q1 in_data 0 18 } } }
	filt_4_Q { ap_memory {  { filt_4_Q_address0 mem_address 1 3 }  { filt_4_Q_ce0 mem_ce 1 1 }  { filt_4_Q_we0 mem_we 1 1 }  { filt_4_Q_d0 mem_din 1 18 } } }
}
