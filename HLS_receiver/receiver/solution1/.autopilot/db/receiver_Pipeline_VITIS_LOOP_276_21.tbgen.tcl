set moduleName receiver_Pipeline_VITIS_LOOP_276_21
set isTopModule 0
...
set C_modelName {receiver_Pipeline_VITIS_LOOP_276_21}
set C_modelType { void 0 }
set C_modelArgList {
	{ real_output int 32 regular {array 236 { 1 3 } 1 1 }  }
	{ real_sample_pkt_keep int 4 regular  }
	{ real_sample_pkt_strb int 4 regular  }
	{ real_sample_pkt_user int 2 regular  }
	{ real_sample_pkt_id int 5 regular  }
	{ real_sample_pkt_dest int 6 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "real_output", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "real_sample_pkt_keep", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "real_sample_pkt_strb", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "real_sample_pkt_user", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "real_sample_pkt_id", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "real_sample_pkt_dest", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ real_sample_pkt_keep sc_in sc_lv 4 signal 1 } 
	{ real_sample_pkt_strb sc_in sc_lv 4 signal 2 } 
	{ real_sample_pkt_user sc_in sc_lv 2 signal 3 } 
	{ real_sample_pkt_id sc_in sc_lv 5 signal 4 } 
	{ real_sample_pkt_dest sc_in sc_lv 6 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "real_sample_pkt_keep", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "real_sample_pkt_keep", "role": "default" }} , 
 	{ "name": "real_sample_pkt_strb", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "real_sample_pkt_strb", "role": "default" }} , 
 	{ "name": "real_sample_pkt_user", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "real_sample_pkt_user", "role": "default" }} , 
 	{ "name": "real_sample_pkt_id", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "real_sample_pkt_id", "role": "default" }} , 
 	{ "name": "real_sample_pkt_dest", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "real_sample_pkt_dest", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	real_sample_pkt_keep { ap_none {  { real_sample_pkt_keep in_data 0 4 } } }
	real_sample_pkt_strb { ap_none {  { real_sample_pkt_strb in_data 0 4 } } }
	real_sample_pkt_user { ap_none {  { real_sample_pkt_user in_data 0 2 } } }
	real_sample_pkt_id { ap_none {  { real_sample_pkt_id in_data 0 5 } } }
	real_sample_pkt_dest { ap_none {  { real_sample_pkt_dest in_data 0 6 } } }
