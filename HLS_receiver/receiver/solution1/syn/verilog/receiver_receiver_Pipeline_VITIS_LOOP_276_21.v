...
module receiver_receiver_Pipeline_VITIS_LOOP_276_21 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        real_output_ce0,
        real_output_q0,
        real_sample_pkt_keep,
        real_sample_pkt_strb,
        real_sample_pkt_user,
        real_sample_pkt_id,
        real_sample_pkt_dest,
        output_i_TDATA,
        output_i_TVALID,
        output_i_TKEEP,
        output_i_TSTRB,
...
input  [3:0] real_sample_pkt_keep;
input  [3:0] real_sample_pkt_strb;
input  [1:0] real_sample_pkt_user;
input  [4:0] real_sample_pkt_id;
input  [5:0] real_sample_pkt_dest;
...
wire   [63:0] i_20_cast_fu_241_p1;
reg   [7:0] i_fu_102;
wire   [7:0] add_ln276_fu_235_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln276_fu_229_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln276_fu_229_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln276_fu_235_p2 = (ap_sig_allocacmp_i_3 + 8'd1);
...
assign i_20_cast_fu_241_p1 = ap_sig_allocacmp_i_3;

assign icmp_ln276_fu_229_p2 = ((ap_sig_allocacmp_i_3 == 8'd224) ? 1'b1 : 1'b0);

assign imag_output_address0 = i_20_cast_fu_241_p1;

assign output_i_TDATA = real_output_q0;

assign output_i_TDEST = real_sample_pkt_dest;

assign output_i_TID = real_sample_pkt_id;

assign output_i_TKEEP = real_sample_pkt_keep;

assign output_i_TLAST = 1'd0;

assign output_i_TSTRB = real_sample_pkt_strb;

assign output_i_TUSER = real_sample_pkt_user;
...
assign real_output_address0 = i_20_cast_fu_241_p1;

endmodule //receiver_receiver_Pipeline_VITIS_LOOP_276_21
