/*
	Filename: main.cpp
	User interface file with tranmistter
*/
...
int main(int argc, char *argv[]){
  ...
  // The encoder doubles the size and convolutional encoder is zero tailed
  // instead of tail biting so it adds 12 tail bits at the end.
  int N = (len * 8) + 12;
