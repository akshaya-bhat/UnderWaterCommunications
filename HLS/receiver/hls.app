<project xmlns="com.autoesl.autopilot.project" name="receiver" top="receiver">
    <includePaths/>
    <libraryPaths/>
    <Simulation>
    ...
    <files xmlns="">
        <file name="../../rx_src/receiver_tb.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        ...
        <file name="rx_src/receiver.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="rx_src/parity_table.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="rx_src/matrixOperations.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="rx_src/matrixOperations.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="rx_src/eigen.h" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="rx_src/eigen.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
