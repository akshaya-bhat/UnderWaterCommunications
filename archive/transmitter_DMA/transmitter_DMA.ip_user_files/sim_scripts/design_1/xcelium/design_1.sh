...
execute()
{
  xrun $xrun_opts \
       ...
       +incdir+"$ref_dir/../../../../transmitter_DMA.gen/sources_1/bd/design_1/ipshared/bb1d/hdl/verilog" \
       ...
       +incdir+"../../../../transmitter_DMA.gen/sources_1/bd/design_1/ipshared/bb1d/hdl/verilog" \
       +incdir+"../../../../transmitter_DMA.gen/sources_1/bd/design_1/ip/design_1_transmitter_0_1/drivers/transmitter_v1_0/src" \
